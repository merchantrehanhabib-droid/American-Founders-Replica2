      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <Button size="lg" className="bg-navy hover:bg-navy/90 text-white font-bold px-8 h-14 rounded-md">
              Get Started
            </Button>
          </motion.div>
          ...
          <div className="relative h-48 lg:h-64 flex items-center justify-end -mr-20 lg:-mr-0">
            {images.map((img, i) => (
              <motion.div
                ...
                className="absolute w-32 md:w-40 shadow-xl rounded-sm border-2 border-white/50"
                style={{ 
                  right: `${i * 80 + 20}px`,
                  zIndex: 10 - i,
